...
.bg-primary {
    background-color: #f1aa09 !important;
}

.bg-primary-hover {
    background-color: #c48904 !important;
}
...
.blockquote {
    border-left: 0.25rem solid #f1aa09;
    padding: 0.5rem 1rem;
}

.blockquote-reverse {
    border-right: 0.25rem solid #f1aa09;
    border-left: 0;
}
...
/* extra menu styles */
.stacked-menu {
    border-bottom: 2px solid #f1aa09;
}
...
.primary-accordion.w-icon .card-header:first-child {
    border-radius: 0;
    border-bottom: 1px solid #c48904;
}
